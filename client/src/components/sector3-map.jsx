...
const routeWaypoints = [
  [19.89475, 73.69645], // Entry from Mumbai road
  [19.91463, 73.70736], // Rajur Bahula Outer Parking
  [19.98710, 73.78271], // Mahamarg Bus Stand Inner Parking
  [20.00158, 73.80432], // Laxmi Narayan Ghat
];

const markers = [
  { pos: [19.89475, 73.69645], label: 'Entry — Mumbai Road',              sublabel: 'Starting Point',  color: '#16a34a' },
  { pos: [19.91463, 73.70736], label: 'Rajur Bahula Outer Parking',        sublabel: 'Outer Parking',   color: '#1d4ed8' },
  { pos: [19.98710, 73.78271], label: 'Mahamarg Bus Stand Inner Parking',  sublabel: 'Inner Parking',   color: '#b91c1c' },
  { pos: [20.00158, 73.80432], label: 'Laxmi Narayan Ghat',                sublabel: 'Destination',     color: '#7c3aed' },
];

const legendItems = [
  { color: '#16a34a', label: 'Entry — Mumbai Road' },
  { color: '#1d4ed8', label: 'Outer Parking — Rajur Bahula' },
  { color: '#b91c1c', label: 'Inner Parking — Mahamarg Bus Stand' },
  { color: '#7c3aed', label: 'Ghat — Laxmi Narayan Ghat' },
...
export default function Sector3Map() {

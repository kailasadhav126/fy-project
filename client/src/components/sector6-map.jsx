...
const routeWaypoints = [
  [20.09317, 73.80597], // Entry from Dindori road
  [20.03287, 73.80307], // stay straight on Dindori road until here, then turn
  [20.03100, 73.81500], // on Meri-Rashbihari Link Road heading east
  [20.01944, 73.83162], // route guide point
  [20.00921, 73.80625], // route guide point
  [20.00149, 73.79903], // Talkuteshwar Ghat
];

const markers = [
  { pos: [20.09317, 73.80597], label: 'Entry — Dindori Road',                    sublabel: 'Starting Point', color: '#16a34a' },
  { pos: [20.08079, 73.80601], label: 'Health Science University Outer Parking', sublabel: 'Outer Parking',  color: '#1d4ed8' },
  { pos: [20.01597, 73.81955], label: 'Ratan Luth Estate Inner Parking',         sublabel: 'Inner Parking',  color: '#b91c1c' },
  { pos: [20.00149, 73.79903], label: 'Talkuteshwar Ghat',                       sublabel: 'Destination',    color: '#7c3aed' },
];

const legendItems = [
  { color: '#16a34a', label: 'Entry — Dindori Road' },
  { color: '#1d4ed8', label: 'Outer Parking — Health Science University' },
  { color: '#b91c1c', label: 'Inner Parking — Ratan Luth Estate' },
  { color: '#7c3aed', label: 'Ghat — Talkuteshwar Ghat' },
...
export default function Sector6Map() {

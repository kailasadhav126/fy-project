...
const routeWaypoints = [
  [19.94840, 73.84078], // Nashik Road Railway Station
  [19.98980, 73.84636], // Dasak Ghat
];

const markers = [
  { pos: [19.94840, 73.84078], label: 'Nashik Road Railway Station', sublabel: 'Starting Point', color: '#16a34a' },
  { pos: [19.98980, 73.84636], label: 'Dasak Ghat',                  sublabel: 'Destination',    color: '#7c3aed' },
];

const legendItems = [
  { color: '#16a34a', label: 'Nashik Road Railway Station' },
  { color: '#7c3aed', label: 'Ghat — Dasak Ghat' },
  { color: '#ea580c', label: 'Route (via Jail Road)', isLine: true },
];
...
export default function Sector10Map() {

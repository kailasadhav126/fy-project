...
const routeWaypoints = [
  [20.00176, 73.87900], // Entry from Shambhaji Nagar road
  [19.98993, 73.84640], // Nandur Manur Ghat
];

const markers = [
  { pos: [20.00176, 73.87900], label: 'Entry — Shambhaji Nagar Road', sublabel: 'Starting Point', color: '#16a34a' },
  { pos: [20.00324, 73.86598], label: 'Mhadsangvi Outer Parking',     sublabel: 'Outer Parking',  color: '#1d4ed8' },
  { pos: [19.98993, 73.84640], label: 'Nandur Manur Ghat',            sublabel: 'Destination',    color: '#7c3aed' },
];

const legendItems = [
  { color: '#16a34a', label: 'Entry — Shambhaji Nagar Road' },
  { color: '#1d4ed8', label: 'Outer Parking — Mhadsangvi' },
  { color: '#7c3aed', label: 'Ghat — Nandur Manur Ghat' },
...
export default function Sector4Map() {

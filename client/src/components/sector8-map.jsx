...
const routeWaypoints = [
  [19.95743, 73.60587], // Entry from Trimbakeshwar road
  [19.96375, 73.64265], // Khambale Outer Parking
  [19.99146, 73.73142], // Satpur Bus Stand Inner Parking
  [20.00468, 73.79305], // Rokdoba Maidan Ghat
];

const markers = [
  { pos: [19.95743, 73.60587], label: 'Entry — Trimbakeshwar Road',        sublabel: 'Starting Point', color: '#16a34a' },
  { pos: [19.96375, 73.64265], label: 'Khambale Outer Parking',            sublabel: 'Outer Parking',  color: '#1d4ed8' },
  { pos: [19.99146, 73.73142], label: 'Satpur Bus Stand Inner Parking',    sublabel: 'Inner Parking',  color: '#b91c1c' },
  { pos: [20.00468, 73.79305], label: 'Rokdoba Maidan Ghat',               sublabel: 'Destination',    color: '#7c3aed' },
];

const legendItems = [
  { color: '#16a34a', label: 'Entry — Trimbakeshwar Road' },
  { color: '#1d4ed8', label: 'Outer Parking — Khambale' },
  { color: '#b91c1c', label: 'Inner Parking — Satpur Bus Stand' },
  { color: '#7c3aed', label: 'Ghat — Rokdoba Maidan Ghat' },
...
export default function Sector8Map() {
